...
| `aruaru-dist` | Integrazione openraft, sharding per intervalli, gestione dei nodi, associazione commit Raft x snapshot open-raid-z (`snapshot_pairing`, aggiunto il 2026-07-13) |
