...
| `aruaru-dist` | Integración con openraft, sharding por rangos, gestión de nodos, vinculación de commits Raft con snapshots de open-raid-z (`snapshot_pairing`, añadido 2026-07-13) |
