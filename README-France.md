...
| `aruaru-dist` | Intégration openraft, sharding par plages, gestion des nœuds, association commit Raft x snapshot open-raid-z (`snapshot_pairing`, ajouté le 2026-07-13) |
