...
const SERVER_BASE = "http://localhost:4000";          // 管理API (REST/JSON)
const SERVER_GQL = "http://localhost:4000/graphql";   // GraphQL
...
export default function App() {
  ...
  useEffect(() => {
    const checkServer = async () => {
      ...
      setServerStatus({ online, version: "0.4.0" });
    };
    checkServer();
    ...
    <div className="flex h-screen bg-gray-950 text-gray-100 font-mono">
      ...
      <aside className="w-56 bg-gray-900 border-r border-gray-800 flex flex-col">
        <div className="p-4 border-b border-gray-800">
          ...
          <p className="text-xs text-gray-500 mt-1">Admin v0.4.0</p>
        </div>
