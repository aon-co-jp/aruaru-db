...
`poem-cosmo-tauri`/`open-runo`, PostgreSQL и `open-raid-z`: гибрид
VersionLess API и версионирования на основе Git поверх утроенного
резервированного транспорта TCP-IP/UDP-IP, призванный предотвратить
потерю данных платных предметов и финансовых/биржевых данных в 3D
онлайн-играх. aruaru-db выступает в ней как распределённый слой данных
Git-on-SQL (подробности см. в `CLAUDE.md`).
